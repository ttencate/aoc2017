...
class Generator is Iterator[U64]
  ...
  new create(factor: U64, modulo: U64, start: U64) =>
    _factor = factor
    _modulo = modulo
    _value = start
...
actor Main
  ...
  be judge(startA: U64, startB: U64) =>
    let generatorA = Generator.create(16807, 4, startA)
    let generatorB = Generator.create(48271, 8, startB)
    var count: U64 = 0
    var matches: U64 = 0
